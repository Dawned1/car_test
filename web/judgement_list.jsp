...
<table width="100%" border="2" align="center" cellpadding="6" cellspacing="3" bordercolor="SkyBlue" style="border-collapse:collapse">
    ...
    <%
        ...
        String fysql="select count(id) as ss from judgement";
...
//        }
        ...
        sql="";
        sql="select top "+page_record+" * from judgement where id not in (select top "+((curpage-1)*page_record)+" id from judgement order by id desc) ";
...
//            updateTime=RS_result.getString("updateTime");
    ...
    <tr>
        ...
        <td width="60" align="center">
            <a href="judgement_update.jsp?id=<%=id%>">修改</a>
            <a href="del.jsp?id=<%=id %>&tablename=judgement" onClick="return confirm('真的要删除？')">删除</a>
        </td>
    </tr>
<%--    <%--%>
<%--        }--%>
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　
    <a href="judgement_list.jsp?page=1">首页</a>　
    <a href="judgement_list.jsp?page=<%= curpage-1%>">上一页</a>　
    <a href="judgement_list.jsp?page=<%= curpage+1%>">下一页</a>　
    <a href="judgement_list.jsp?page=<%=zys %>">尾页</a>　当前第<FONT color=red><%=curpage %></FONT>页/共<FONT color=red><%=zys %></FONT>页</p>
</body>
</html>
