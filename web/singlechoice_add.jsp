...
<%--        //if(document.form1.shiti.value==""){alert("请输入试题");document.form1.shiti.focus();return false;}--%>
...
<%--</script>--%>
<body>
<form name="form1" id="form1" method="post" action="singlechoice_add_post.jsp">
    添加选择题:<br><br>
